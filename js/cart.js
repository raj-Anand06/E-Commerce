let cart = localStorage.getItem("cart")
    ...
    function displayCartProduct() {
        ...
        cart.forEach((item) => {
            ...
            const updatedPrice = item.price.newPrice ;
            const totalPrice = updatedPrice * item.quantity;
            ...
            <tr class="cart-item">
                ...
                <td>${item.name}</td>
                <td>₹${updatedPrice.toFixed(2)}</td>  <!-- Display updated price -->
                <td>${item.quantity}</td>
                <td>₹${totalPrice.toFixed(2)}</td>  <!-- Display updated total price -->
            </tr>
            `
        })
